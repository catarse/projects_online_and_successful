...
ggplot() + 
    xlab("Data") +
    geom_line(col = 'black', aes(x = xaxis, y = total), data = projects) +
    geom_line(col = 'red', aes(x = xaxis, y = nao_financiados), data = projects) +
    geom_line(col = 'blue', aes(x = xaxis, y = financiados), data = projects)
```
...
ggplot(data = projects) + 
    ...
    geom_point(col = 'red', aes(x = total, y = nao_financiados)) +
    geom_point(col = 'blue', aes(x = total, y = financiados)) +
    stat_smooth(col = 'red', aes(x = total, y = nao_financiados), method="lm", se=FALSE) +
    stat_smooth(col = 'blue', aes(x = total, y = financiados), method="lm", se=FALSE)
```
